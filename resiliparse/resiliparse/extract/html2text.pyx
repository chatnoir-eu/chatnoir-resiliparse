...
cdef RE2 sidebar_cls_regex = RE2(rb'(?:^|\s)(?:l-|wp-|right|left|global)?sidebar|widget|one-third(?:$|[\s_-])', re_opts)
...
cdef RE2 modal_cls_regex = RE2(rb'(?:^|\s)(?:wp-|p-)?(?:modal|popup|lightbox|gallery)(?:[_-]*(?:window|pane|box))?(?:$|[\s_-])', re_opts)
