...
cdef RE2 nav_cls_regex = RE2(rb'(?:^|\s)(?:(?:l-|wp-|main|site|page|sub|article)[_-]*)?(?:nav(?:bar|igation|box)?|menu(?:[_-]item)?|dropdown|bread[_-]?crumbs?)|(?:link[_-]?(?:list|container))(?:$|[\s_-])', re_opts)
...
cdef RE2 header_cls_regex = RE2(rb'(?:^|\s)(?:l-|wp-|global|page|site|full)[_-]*header|header[_-](?:wrap(?:per)?|bar)(?:$|\s)', re_opts)
