...
class DOMCollection(Sequence[DOMNode]):
    ...
    def get_elements_by_class_name(self, class_name: str, case_insensitive: bool = False) -> DOMCollection[DOMNode]: ...
...
class DOMNode(Iterable[DOMNode]):
    ...
    def get_elements_by_class_name(self, class_name: str, case_insensitive: bool = False) -> DOMCollection: ...
