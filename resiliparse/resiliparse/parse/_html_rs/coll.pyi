...
from typing import Container, Iterable, Optional, overload, Sequence, Tuple, TypeVar
...
class DOMTokenList(Sequence[str], Container[str]):
    ...
    def remove(self, tokens: Iterable[str]): ...
    def replace(self, old_token: str, new_token: str): ...
    def toggle(self, token: str, force: bool = False): ...
